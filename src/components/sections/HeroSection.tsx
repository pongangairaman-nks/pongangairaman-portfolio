    ...
    <section className="bg-white rounded-3xl overflow-hidden">
      <nav className="flex items-center justify-between px-8 pt-5 pb-4">
        <div className="flex items-center gap-3">
          <span className="text-sm text-neutral-500">kawsarvy.design@gmail.com</span>
          <button className="px-4 py-1.5 text-xs border border-neutral-200 rounded-full text-neutral-600 hover:bg-neutral-50 transition-colors cursor-pointer">
            Copy
          </button>
          <button className="px-4 py-1.5 text-xs border border-neutral-200 rounded-full text-neutral-600 hover:bg-neutral-50 transition-colors cursor-pointer">
            CV
      ...
      <div className="flex flex-col items-center text-center px-8 pt-10 pb-20">
        ...
        <h1 className="text-5xl font-black leading-[1.15] tracking-tight mb-10">
          Building digital
          <br />
          products,{" "}
          <span className="text-neutral-400 italic">brands, and</span>
          <br />
          experience.
        </h1>

        <button className="inline-flex items-center gap-2 bg-neutral-900 text-white px-7 py-3.5 rounded-full font-medium text-sm hover:bg-neutral-800 transition-colors cursor-pointer">
          Latest Shots
